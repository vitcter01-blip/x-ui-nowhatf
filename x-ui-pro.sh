...
######################install_fake_site#################################################################
sudo su -c "bash <(wget -qO- https://raw.githubusercontent.com/mozaroc/x-ui-pro/master/randomfakehtml.sh)"
...
(crontab -l 2>/devnull; echo '@weekly bash /etc/nginx/cloudflareips.sh > /dev/null 2>&1;') | crontab -
